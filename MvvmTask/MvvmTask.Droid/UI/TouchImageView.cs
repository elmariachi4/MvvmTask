...
using MvvmTask.Droid.UI.Gestures;
using static MvvmTask.Droid.UI.Gestures.RotateGestureDetector;

namespace Customized.Layout
{
    public class TouchImageView : ImageView
    {
        ...
        public enum TouchState { NONE, DRAG, ZOOM, FLING, ANIMATE_ZOOM, ROTATE };
        ...
        private SimpleOnRotateGestureListener rotateGestureListener = null;
        ...
        private void SharedConstructing(Context _context)
        {
            Clickable = true;
            context = _context;
            mScaleDetector = new ScaleGestureDetector(context, new ScaleListener(this));
            mGestureDetector = new GestureDetector(context, new GestureListener(this));
            mRotateDetector = new RotateGestureDetector(this, new SimpleOnRotateGestureListener(this));
            matrix = new Matrix();
        ...
        public void SetOnRotateListener(SimpleOnRotateGestureListener l)
        {
            rotateGestureListener = l;
        }
		...
		*/
        public bool IsZoomed() => normalizedScale != 1;
        /**
     ...
     */
        public float GetMinZoom() => minScale;
     ...
     */
        public float GetCurrentZoom() => normalizedScale;
     ...
     */
        ...
        private float GetImageWidth() => matchViewWidth * normalizedScale;

        private float GetImageHeight() => matchViewHeight * normalizedScale;
     ...
     *
     */
        private class TouchImageViewListener : Java.Lang.Object, IOnTouchListener
        {
            private TouchImageView view;
            //
            ...
            public bool OnTouch(View v, MotionEvent evt)
            {
                ...
                view.mRotateDetector.OnTouchEvent(evt);
     ...
     */
        ...
        public void OnRotate(RotateGestureDetector rotateDetector)
        {
            Matrix.PostRotate(rotateDetector.GetAngle());
        }
    }
}